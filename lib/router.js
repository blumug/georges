Router.configure({
  ...
  waitOn: function() {
    ...
    Meteor.subscribe('notifications-invitation');
    Meteor.subscribe('notifications-desinscription');
    Meteor.subscribe('notifications-message');
...
Router.onBeforeAction(mustBeSignedIn, {
  except: ['landing', 'login', 'register', 'passwordRecovery', 'export']
});